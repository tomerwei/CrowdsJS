  ...
  function addColumnAgentGroup(
    ...
    while (i < numAgents) {
      agentData.push({
        ...
        cur_rotation_angle_deg: 0.0,
        prev_rotation_angle_deg: 0.0,
        cur_rotation_angle_rad: 0.0,
        prev_rotation_angle_rad: 0.0,
        
        last_used_rotation_angle_rad: 0.0,

        velocityVector_i_norm: 0.0,
        last_hundred_pos: [],
